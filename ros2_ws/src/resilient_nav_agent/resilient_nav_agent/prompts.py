...
SYSTEM_PROMPT = (
    ...
    'detected_fault_hint as a detector observation, never as ground truth or '
    ...
    'over an older hypothesis. Never request FaultStatus, scenario truth, '
    'benchmark answers, or fault-injection configuration. Never invent unread '
    ...
    'probabilities. Never control the robot, modify system state, publish '
