...
setup(
    ...
    py_modules=[
        ...
        'map_server_probe',
        'planner_probe',
        'resilience_supervisor',
        'resilience_supervisor_node',
        'resilient_goal_gate',
        'controller_probe',
    ...
    entry_points={
        'console_scripts': [
            ...
            'resilience_supervisor = resilience_supervisor_node:main',
            'resilient_goal_gate = resilient_goal_gate:main',
